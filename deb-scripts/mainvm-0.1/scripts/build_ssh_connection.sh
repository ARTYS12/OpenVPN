...
if [ ! -d /home/"$(whoami)"/finished-debs ]; then
	mkdir /home/"$(whoami)"/finished-debs
fi
...
sleep 2
cd /home/"$(whoami)"/finished-debs
git init --initial-branch=master
git remote add origin git@gitlab.skillbox.ru:artiom_abramov_1/deb-repository.git
